...
#Set the URL
theURL2 <- 'https://waterdata.usgs.gov/nwis/uv?search_site_no=02085070&period=24&format=rdb' # dont forget to change the period!
...
the_df = bind_cols(the_states, the_price, the_capacity, net_generation, total_retail)
colnames(the_df) = c("names", "price", "capacity", "")
```
